...
if __name__ == "__main__":
    ...
    if LOAD_MODEL:
        if 'checkpoint' not in args.load_model_name:
            ...
            if base_model == 'roberta':
                model = RobertaPOS.from_pretrained('roberta-base', dataset_label_nums = dataset_label_nums, output_attentions=False, output_hidden_states=False, multi_gpus=True)
            elif base_model == 'bert':
                model = BertPOS.from_pretrained('bert-base-cased', dataset_label_nums = dataset_label_nums, output_attentions=False, output_hidden_states=False, multi_gpus=True)
